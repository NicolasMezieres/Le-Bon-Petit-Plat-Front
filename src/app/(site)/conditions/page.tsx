    ...
    <main className="py-10 px-6 md:px-20 w-full flex flex-col items-center gap-5 font-['Lato']">
      <div className="flex flex-col justify-center items-center gap-5 xl:w-[640px] ">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <p className="md:pr-5">
            Tous les contenus présents sur le site &quot;Le Bon Petit Plat&quot; (textes, images,
            logos, vidéos, etc.) sont protégés par les dispositions du Code de la propriété
            intellectuelle et sont la propriété exclusive de leurs auteurs respectifs. Toute
            reproduction, diffusion ou utilisation de ces contenus sans autorisation préalable est
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <p className="md:pr-6">
            Pour toute demande d&apos;information ou réclamation, vous pouvez nous contacter à
            l&apos;adresse suivante : contact@lbpp.com
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-5 xl:w-[640px]">
        <div className="flex flex-col gap-2.5 px-0.5">
          ...
          <p className="pr-2">
            En accédant et en utilisant le site, l&apos;utilisateur reconnaît avoir pris
          ...
          <p className="pr-[10px] md:pr-6">
            ...
            l&apos;utilisateur doit s&apos;inscrire en créant un compte. Il s&apos;engage à fournir
            des informations exactes, complètes et à jour. L&apos;utilisateur est seul responsable
            de la confidentialité de son mot de passe.
          </p>
          <ThirdTitle additionalCSS="text-start" text={"Article 4 : Publication de contenu"} />
          <p className="pr-[10px] md:pr-6">
            L&apos;utilisateur peut publier des recettes, commentaires et autres contenus sur le
            site. En publiant, il garantit que les contenus respectent la législation en vigueur et
            ne contiennent aucun élément diffamatoire, illégal ou inapproprié. L&apos;équipe de
            modération se réserve le droit de supprimer tout contenu qui contreviendrait à ces
            règles.
          </p>
          <ThirdTitle
          ...
          <p className="pr-2 md:pr-8">
            L&apos;utilisateur est responsable des contenus qu&apos;il publie sur le site.
            L&apos;éditeur du site ne saurait être tenu responsable des contenus publiés par les
            utilisateurs. Toutefois, en cas de signalement d&apos;un contenu illicite, le site se
            réserve le droit de le supprimer après vérification.
          </p>
      ...
      <div className="flex flex-col gap-5 xl:w-[640px]">
        <div className="flex flex-col gap-2.5">
          ...
          <div>
            <p>
              Lors de l&apos;inscription sur le site, nous collectons les informations suivantes :
            </p>
            <ul className="list-disc pl-5">
              ...
              <li>Prénom</li>
              <li>
                Toute autre information fournie volontairement par l&apos;utilisateur dans son
                profil.
              </li>
            </ul>
          </div>
          ...
          />
          <p className="md:pr-7">
            Conformément à la loi &quot;Informatique et Libertés&quot;, les utilisateurs disposent
            d’un droit d’accès, de rectification et de suppression des données personnelles les
            concernant. Pour exercer ces droits, vous pouvez contacter contact@lbpp.com.
          </p>
