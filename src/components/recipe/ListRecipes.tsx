...
const ListRecipes = ({listRecipes, isNextPage, page , setPage}:{listRecipes: lookRecipeType[], isNextPage:boolean, page:number, setPage: React.Dispatch<React.SetStateAction<number>>}) => {
  ...
  return (
    <section className="flex flex-col gap-4 md:grid md:grid-cols-2 md:gap-y-5 md:gap-x-2 xl:grid-cols-3 xl:gap-5 ">
        ...
        <Pagination additionalCSSDiv="md:col-span-2 xl:col-span-3" isNextPage={isNextPage} page={page} setPage={setPage} />
      </section>
  )
}
